...
$sql = "INSERT INTO `test6`.`user6`(`name`, `email`, `password`, `message`)VALUES( '$name', '$email', '$password', '$message')";
 ...
 if($con->query($sql) == true){     echo "<h1>Thanks For Join Our Contact Form</h1>";
 }
    else{
    ...
    <div class="row justify-content-evenly pt-3 pb-5 bg-info">
        <div class="col-md-5 mt-5 mt-5" style=" padding-top: 100px;">
            ...
            <form action="contact.php" method="POST">
                ...
                <!-- <button class="bg-info" > <a href="check form.php" class="check">Chech Form</a></button> -->
                <a class="btn btn-danger" href="check form.php" role="button">Check Form</a>
            </form>
        </div>
     ...
     <div class="row justify-content-evenly bg-dark text-white pt-2 pb-5">
        <div class="col-md-2 pt-4">
           <a href="project 2.html"> <h3>Home</h3></a>
        ...
        <div class="col-md-2 pt-4">
            <h3>Contact</h3>
                ...
                <i class="bi bi-telephone"></i>: 9350564435
        </div>
    </div>
